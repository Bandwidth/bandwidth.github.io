...
|:----------|:------------|:----------|
| from | A Bandwidth phone number on your account the call should come from (must be in E.164 format, like `+15555551212`, or one of the following acceptable strings: `Restricted`, `RESTRICTED`, `Anonymous`, `ANONYMOUS`, `Private`, `PRIVATE`, `Unavailable`, or `UNAVAILABLE`). | Yes |
