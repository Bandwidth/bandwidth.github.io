...
| [Record Complete](bxml/callbacks/recordComplete.md)     | Bandwidth API sends this to the application when a `<Record>` is completed. To download the recording look for the [Recording Available](bxml/callbacks/recordingAvailable.md) event.                  |
