...
| transferCompleteUrl    | (optional) URL to send the [Transfer Complete](../callbacks/transferComplete.md) event to and request new BXML ([see below](#transferCompleteUrl)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
