...
| terminatingDigits | (optional) When any of these digits are pressed, it will terminate the Gather. Default behavior is disabled. This feature can also be explicitly disabled with `""`.                                                                                                                             |
